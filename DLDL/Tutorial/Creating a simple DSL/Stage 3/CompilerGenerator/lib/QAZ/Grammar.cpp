...
void QAZ::Grammar::GenerateObjects()
{
	...
	declaration.Set(::deamer::language::type::definition::object::main::NonTerminal("declaration", { declaration_variable_declaration.Pointer(),declaration_function_declaration.Pointer() }));
	...
	function_parameters.Set(::deamer::language::type::definition::object::main::NonTerminal("function_parameters", { function_parameters_function_parameter_COMMA_function_parameters.Pointer(),function_parameters_function_parameter_function_parameters.Pointer(),function_parameters_EMPTY.Pointer() }));
	function_arguments.Set(::deamer::language::type::definition::object::main::NonTerminal("function_arguments", { function_arguments_function_argument_COMMA_function_arguments.Pointer(),function_arguments_function_argument_function_arguments.Pointer(),function_arguments_EMPTY.Pointer() }));
	...
	function_argument.Set(::deamer::language::type::definition::object::main::NonTerminal("function_argument", { function_argument_VARNAME.Pointer() }));
	...
	declaration_function_declaration.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->function_declaration.Pointer() }));
	...
	function_parameters_function_parameter_COMMA_function_parameters.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->function_parameter.Pointer(),Language->COMMA.Pointer(),Language->function_parameters.Pointer() }));
	function_parameters_function_parameter_function_parameters.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->function_parameter.Pointer(),Language->function_parameters.Pointer() }));
	function_parameters_EMPTY.Set(::deamer::language::type::definition::object::main::ProductionRule());
	function_arguments_function_argument_COMMA_function_arguments.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->function_argument.Pointer(),Language->COMMA.Pointer(),Language->function_arguments.Pointer() }));
	function_arguments_function_argument_function_arguments.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->function_argument.Pointer(),Language->function_arguments.Pointer() }));
	...
	function_argument_VARNAME.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->VARNAME.Pointer() }));
	...
	AddObject(function_parameters_function_parameter_COMMA_function_parameters);
	AddObject(function_parameters_function_parameter_function_parameters);
	AddObject(function_parameters_EMPTY);
	AddObject(function_arguments_function_argument_COMMA_function_arguments);
	AddObject(function_arguments_function_argument_function_arguments);
	...
	AddObject(function_argument_VARNAME);
