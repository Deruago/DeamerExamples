#ifndef QAZ_GENERATION_H
#define QAZ_GENERATION_H
...
namespace QAZ
{
	...
	/*!	\class Generation
	 *
	 *	\brief This contains the generation LPD of the language QAZ
	 *
...
::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::GenerateArgument> argument_Bison_Declare_deleted_terminals;
	...
	public:
		Generation(QAZ::Language* language)
