...
%nterm<QAZ_function_parameters_at_least_one> function_parameters_at_least_one
%nterm<QAZ_function_parameters> function_parameters
%nterm<QAZ_function_argument_at_least_one> function_argument_at_least_one
...
declaration:
	...
	| FUNCTION function_declaration {
		auto* const newNode = new QAZ::ast::node::declaration({::QAZ::ast::Type::declaration, ::deamer::external::cpp::ast::NodeValue::nonterminal, {1, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { new QAZ::ast::node::FUNCTION({::QAZ::ast::Type::FUNCTION, ::deamer::external::cpp::ast::NodeValue::terminal, $1}), $2 });
		$$ = newNode;
	}
;
...
function_parameters_at_least_one:
	function_parameter COMMA function_parameters_at_least_one {
		auto* const newNode = new QAZ::ast::node::function_parameters_at_least_one({::QAZ::ast::Type::function_parameters_at_least_one, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1, new QAZ::ast::node::COMMA({::QAZ::ast::Type::COMMA, ::deamer::external::cpp::ast::NodeValue::terminal, $2}), $3 });
		$$ = newNode;
	}
	| function_parameter {
		auto* const newNode = new QAZ::ast::node::function_parameters_at_least_one({::QAZ::ast::Type::function_parameters_at_least_one, ::deamer::external::cpp::ast::NodeValue::nonterminal, {1, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
;
...
function_parameters:
	function_parameters_at_least_one {
		auto* const newNode = new QAZ::ast::node::function_parameters({::QAZ::ast::Type::function_parameters, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
	| {
...
function_argument_at_least_one:
	function_argument COMMA function_argument_at_least_one {
		auto* const newNode = new QAZ::ast::node::function_argument_at_least_one({::QAZ::ast::Type::function_argument_at_least_one, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1, new QAZ::ast::node::COMMA({::QAZ::ast::Type::COMMA, ::deamer::external::cpp::ast::NodeValue::terminal, $2}), $3 });
		$$ = newNode;
	}
	| function_argument {
		auto* const newNode = new QAZ::ast::node::function_argument_at_least_one({::QAZ::ast::Type::function_argument_at_least_one, ::deamer::external::cpp::ast::NodeValue::nonterminal, {1, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
;
...
function_arguments:
	function_argument_at_least_one {
		auto* const newNode = new QAZ::ast::node::function_arguments({::QAZ::ast::Type::function_arguments, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
	| {
...
function_argument:
	call {
		auto* const newNode = new QAZ::ast::node::function_argument({::QAZ::ast::Type::function_argument, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
	| value {
		auto* const newNode = new QAZ::ast::node::function_argument({::QAZ::ast::Type::function_argument, ::deamer::external::cpp::ast::NodeValue::nonterminal, {1, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { $1 });
		$$ = newNode;
	}
;
