...
namespace QAZ { namespace ast { namespace listener { 
	...
	public:
		void Dispatch(const ::deamer::external::cpp::ast::Node* node) override
		{
			...
			{
				Listen(static_cast<const QAZ::ast::node::FUNCTION*>(node));
				break;
			}
			...
			{
				Listen(static_cast<const QAZ::ast::node::function_parameters_at_least_one*>(node));
				DefaultAction(node);
				break;
			}
			...
			{
				Listen(static_cast<const QAZ::ast::node::function_argument_at_least_one*>(node));
				DefaultAction(node);
				break;
			}
		...
		virtual void Listen(const QAZ::ast::node::EQUAL_EQUAL* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::EQUAL* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::PLUS* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::MINUS* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::MULTIPLY* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::DIVIDE* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::LEFT_PARENTHESIS* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::RIGHT_PARENTHESIS* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::LEFT_BRACKET* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::RIGHT_BRACKET* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::LEFT_SQUARE_BRACKET* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::RIGHT_SQUARE_BRACKET* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::COMMA* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::SEMICOLON* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::INTEGER_TYPE* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::STRING_TYPE* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::RETURN* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::FUNCTION* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::VARNAME* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::DECIMAL* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::NUMBER* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::SPACES* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::ESCAPE_CHARS* node)
		{
		}

		virtual void Listen(const QAZ::ast::node::program* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::stmts* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::stmt* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::declaration* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::global_call* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::call* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_call* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::variable_call* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::assignment* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::expression* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::variable_declaration* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_declaration* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::variable_assignment* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::return_assignment* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_parameters_at_least_one* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_parameters* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_argument_at_least_one* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_arguments* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_block* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_parameter* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_argument* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::function_name* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::return_type* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::variable* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::type* node)
		{
		}
		virtual void Listen(const QAZ::ast::node::value* node)
		{
		}
	private:
